...
/**
 * A helper object to parse a JSON on GCS. Usage is to provide A GCS URL and it will return a JSONObject of the file
 */
public class SchemaParser {
  ...
  /**
   * Parses a JSON file and Returns a JSONObject containing the necessary source, sink, and schema information.
   *
